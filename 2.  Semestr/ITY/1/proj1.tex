\documentclass[twocolumn, 10pt, a4paper]{article} %nastavení typu dokumentu a formátování sloupců + velikost základního písma
\usepackage[czech]{babel} %importování balíčku pro češtinu
\usepackage[T1]{fontenc} %specifikace fontu ze zadání
\usepackage{xcolor} %import barev
...
\usepackage[left=1.8cm,text={18.2cm, 24.1 cm},top=1.8cm]{geometry} %nastavení okrajů stránky
...
\date{\vspace{-3ex}} %opomenutí data a odstranění mezery vyhrazené pro datum


\begin{document}

\maketitle %vytvoření titulní stránky
...
\section{Smíšená sazba}
    ...
    Existuje \uv{pravidlo}:
        \begin{quotation}
            Čím více \textsc{druhů}, \emph{řezů}, {\tiny velikostí}, \textcolor{red}{barev} písma a jiných {\fontfamily{cmtt}\selectfont efektů} použijeme, \underline{tím profesionálněji} bude {\fontfamily{pzc}\selectfont dokument} vypadat.
